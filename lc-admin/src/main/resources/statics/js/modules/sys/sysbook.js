$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '预约房间', name: 'bookType', index: 'book_type', width: 80 },
			{ label: '预约开始时间', name: 'bookStartTime', index: 'bookStartTime', width: 80 ,
            ...
            { label: '预约结束时间', name: 'bookEndTime', index: 'bookEndTime', width: 80 ,
                formatter: function (cellvalue, options, rowObject) {
                    var date = new Date(cellvalue);
                    var seperator1 = "-";
                    var seperator2 = ":";
